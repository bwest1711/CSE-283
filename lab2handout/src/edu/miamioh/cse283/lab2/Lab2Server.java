...
public class Lab2Server {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			// for convenience, the server should tell us what addresses it's
			// listening on;
			// see DatagramSocket.getLocalSocketAddress() and
			...
			while (true) {
				...
				// - wait the right amount of time to hit the requested sending
				// rate
				// see: Object.wait(long millis) and the concurrency lesson
				// listed in the lab description
